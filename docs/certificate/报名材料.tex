...
%\includepdf[pages=1-2]{figs/二引/5078长沙市一中城南中学.pdf}
...
%\begin{center}
%  \includegraphics[scale=0.6]{figs/硕士就业推荐表1.png }
%  
%  \includegraphics[scale=0.5]{figs/硕士就业推荐表2.png }
%  
%  \includegraphics[scale=0.37]{figs/硕士就业推荐表4.png }
%\end{center}

%\section{学生证}
%\begin{center}
%  \includegraphics[scale=0.1]{figs/学生证1.png }
%  \includegraphics[scale=0.1]{figs/学生证2.png }
%  \includegraphics[scale=0.1]{figs/学生证3.png }
%\end{center}
...
\subsubsection{职称证书}
\begin{center}
\includegraphics[scale=0.25]{figs/中二职称证书.png }
 \end{center}
 
\subsubsection{计算机等级证}
\begin{center}
\includegraphics[scale=0.22]{figs/计算机二级C.png }
\includegraphics[scale=0.4]{figs/计算机二级Python.png }
\includegraphics[scale=0.22]{figs/计算机三级证书.png }
\end{center}
 
\subsubsection{普通话证}
\includegraphics[scale=0.25]{figs/普通话证.png }

\subsubsection{英语六级}

\includegraphics[scale=0.3]{figs/英语六级.png }
...
% \includegraphics[scale=0.27]{figs/2017-06.png }
 \includegraphics[scale=0.1]{figs/2016-05.png }
 \includegraphics[scale=0.1]{figs/2016-01_1.png }
 \includegraphics[scale=0.1]{figs/2016-01_2.png }
 \includegraphics[scale=0.35]{figs/2015-09.png }
 \includegraphics[scale=0.2]{figs/2015-06.png }
% \includegraphics[scale=0.24]{figs/2015-05.png }
\end{center}
...
%\begin{center}
%
% \includegraphics[scale=0.28]{figs/本科成绩单.png }
%
%  \includegraphics[scale=0.4]{figs/硕士成绩单1.png }
%  \includegraphics[scale=0.35]{figs/硕士成绩单2.png }
%\end{center}
