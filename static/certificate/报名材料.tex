...
%\includepdf[pages=1]{docs/中南大学本科生院非事业编制人员招聘报名表.pdf}


%\section{个人简历}
%%\includepdf[pages=1-2]{docs/保险职业学院招聘简历.pdf}
%\includepdf[pages=1]{docs/唐洁简历-工作.pdf}
%\includepdf[pages=1-2]{docs/唐洁简历-博士.pdf}
...
\section{攻读硕士学位期间科研情况}


以一作完成学术论文6篇，以二作参与学术论文1篇, 其中1篇SCI四区在线发表, 1篇核心发表, 1篇核心录用, 1篇普刊见刊, 2篇SCI论文二审, 还有1篇待投稿.

\subsection{发表学术论文}

\nh { \bfseries Tang Jie}, Qin Yongsong. Adjusted empirical likelihood for probability density functions under strong mixing samples. ({\kaishu SCI期刊《Communications in Statistics - Theory and Methods》在线发表})

\nh { \bfseries 唐洁}, 秦永松. 含空间自相关误差的空间自回归模型的调整经验似然推断. ({\kaishu 核心期刊《广西师范大学学报》发表})

\nh { \bfseries Tang Jie}, Zou Yunlong, Qin Yongsong. Blockwise empirical likelihood method for spatial dependent data. ({\kaishu 核心期刊《应用数学》录用})

\nh { \bfseries 唐洁}. 含空间自回归误差的空间自回归模型的经验欧氏似然推断[J]. 广西民族大学学报(自然科学版), 2021, 27(04): 70-74. 

\nh { \bfseries Tang Jie}, Qin Yongsong. Empirical likelihood for spatial dynamic panel data models with spatial errors and endogenous initial observations. ({\kaishu SCI期刊《Acta Mathematicae Applicatae Sinica》二审})
...
%\section{附件}
%\subsection{附件A}
%以下为1篇普刊、1篇核心、1篇SCI论文发表及科研立项证明。

\includepdf[pages=1]{pdfs/论文4发表.pdf}
\includepdf[pages=2]{pdfs/论文4.pdf}

\includepdf[pages=1]{pdfs/论文2录用.pdf}
%\includepdf[pages=1]{pdfs/论文2.pdf}

%\includepdf[pages=1]{pdfs/论文5录用.pdf}
\includepdf[pages=1]{pdfs/论文5.pdf}

\includepdf[pages=1]{pdfs/论文1封面.pdf}
%\includepdf[pages=4]{pdfs/论文1封面.pdf}
\includepdf[pages=1]{pdfs/论文1.pdf}

\includepdf[pages=1]{pdfs/论文3投稿.pdf}
\includepdf[pages=1]{pdfs/论文3.pdf}

\includepdf[pages=1]{pdfs/论文6.pdf}

\includepdf[pages=1]{pdfs/论文7投稿.pdf}
...
%\end{center}
\includepdf[pages=1]{pdfs/成绩单本科.pdf}
