...
%\includepdf[pages=1]{docs/1001湖南国防工业职业技术学院合同制工作人员招聘报名表.pdf}


%\section{个人简历}
%%\includepdf[pages=1-2]{docs/保险职业学院招聘简历.pdf}
%%\includepdf[pages=1-2]{docs/唐洁简历-工作.pdf}
...
%
%\nh { \bfseries 唐洁}, 秦永松. 含空间自相关误差的空间自回归模型的调整经验似然推断. ({\kaishu 核心期刊《广西师范大学学报》录用})
%
...
%
%\nh Li Yufang, { \bfseries Tang Jie}, Qin Yongsong. Empirical likelihood ratio test for linear models with equality constraints. ({\kaishu 二审})
%
